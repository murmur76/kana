...
module.exports = {
  bindRoute: function (app) {
    const pathToControllers = process.env.NODE_ENV === 'kana' ? '../test/fixtures/controllers/' : '../../../app/controllers/';
    const pathToRouteConfig = process.env.NODE_ENV === 'kana' ? '../test/fixtures/config/routes' : '../../../config/routes';
